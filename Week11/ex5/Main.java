...
public class Main {
    public static void main(String[] args) {
        ...
        arr.add(new Employee("Vasila", 18, 6000));
        arr.add(new Employee("Laman", 18, 5998));
        arr.add(new Employee("Ilaha", 19, 6000));
        arr.add(new Employee("Rahima", 17, 5555));
        ...
        arr.sort((sal1, sal2) -> sal1.getSalary() - sal2.getSalary());
