...
public class Main {
        public static void main(String[] args) {
                ...
                person.stream().sorted((a, b) -> a.getName().compareTo(b.getName())).forEach(System.out::println); // sort
                                                                                                                   // by
                                                                                                                   // name
                                                                                                                   // in
                                                                                                                   // alphepatic
                ...
                List<String> wordsStartwithA = Arrays.asList("Alibaba", "shamil", "joejong", "Abrakadabra", "april",
                                "August");
                ...
                var employeDEpartment = employee.stream()
                ...
                List<String> findApple = Arrays.asList("Polar", "color", "apple", "look", "asd", "apple", "prere",
                                "fds");
