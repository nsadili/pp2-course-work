...
public class Calc {
    public static void main(String[] args) {
        ...
        System.out.println("The integer division number1 over number2 is: " + (number1 / number2));
        System.out.println("The integer division number2 over number1 is: " + (number2 / number1));
