...
public class SpecificElement {
    ...
    public static void main(String[] args) {
        ...
        List<String> listString = new ArrayList<>(List.of("Bahruz", "Nigar" , "Ali", "Ramiz", "Qeni", "Ahmed" ));
        System.out.println(count(listString));

        List<Account> listAccount = new ArrayList<>(List.of(new Account("Null", "Null", 0.0), new Account("Null", "Null", 0.0),new Account("Null", "Null", 8.05)));
