...
public class ComplexMaps {
    public static void main(String[] args) {
        ...
        addFriend(friends, "Raiq", "Aslan");
        addFriend(friends, "Raiq", "Nuran");
        addFriend(friends, "Ibrahim", "Mehemmed");
        addFriend(friends, "Ibrahim", "Aslan");
        addFriend(friends, "Aslan", "Mehemmed");
