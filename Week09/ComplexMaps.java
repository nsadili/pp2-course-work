...
public class ComplexMaps {
    ...
    public static void main(String[] args) {
        ...
        addPairOfFriends(friends, "Khadija", "Aylin");
        addPairOfFriends(friends, "Khadija2", "Aylin2");
        addPairOfFriends(friends, "Khadija3", "Aylin3");

        for(String name: friends.keySet()) {
            System.out.println(name + ": " + friends.get(name));
        }

        System.out.println(removeAFriend(friends, "Khadija", "Aylin"));
        System.out.println(removeAFriend(friends, "Mehemmed", "Aylin"));
        System.out.println(removeAFriend(friends, "Khadija", "Mehemmed"));
