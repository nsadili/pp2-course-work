...
public class ComplexMaps {
    public static void main(String[] args) {
        ...
        addPairOfFriends(friends, "Nihat", "Leyla");
        addPairOfFriends(friends, "Nihat", "Malak");
        addPairOfFriends(friends, "Malak", "Ali");
        ...
        removeFriend(friends, "Nihat", "SLeyla");
    ...
    static void addPairOfFriends(Map<String, List<String>> friends, String f1, String f2) {
         ...
         //if(friends.containsKey(f1)) {friends.get(f1).add(f2);
         //}else{
        //var list = new ArrayList<String>();
        //list.add(f2);friends.put(f1, list);}
