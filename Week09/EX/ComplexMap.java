...
public class ComplexMap {
    public static void main(String[] args) {
        ...
        addAPairOfFriends(friends, "Nuraddin", "Ravan");
        addAPairOfFriends(friends, "Nuraddin", "Nasib");
        addAPairOfFriends(friends, "Nasib", "Vasila");
        removeAFriend(friends, "Nuraddin", "Ravan");

        System.out.println(removeAFriend(friends,"Nuraddin", "Ravan"));
        System.out.println(removeAFriend(friends,"Javid", "Ravan"));
        System.out.println(removeAFriend(friends,"Vasila", "Ravan"));
