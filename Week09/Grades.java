...
public class Grades {
    public static void main(String[] args) {
        ...
        for(Map.Entry<String, Double> entry: grades.entrySet()) {
            //if a student with a GPA higher than the current highest GPA, clear the list and add the new student's name
            //if a student with the same GPA as the current highest GPA, add their name to the list
        ...
        System.out.println("The student(s) with the highest GPA are: " + highestGPAs);
