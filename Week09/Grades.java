...
public class Grades {
    public static void main(String[] args) {
        ...
        studentsGPA.put("Leyla Khudiyeva", 4f);
        studentsGPA.put("Mae Swift", 3.2f);
        studentsGPA.put("Hope Mikaelson", 1f);
        studentsGPA.put("Tony Lanez", 2f);
        studentsGPA.put("Sam Johnson", 4f);
        ...
        System.out.println("Number of students whose GPA is less than the average is: " + lessThanAverage.size());
    }
}