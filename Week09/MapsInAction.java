...
public class MapsInAction {
    public static void main(String[] args) {
        ...
        nameAndAge.put("Mae", 35);
        nameAndAge.put("Sherlock", 19);
        nameAndAge.put("Mycroft", 22);
        nameAndAge.put("John", 25);
        ...
        System.out.println("Entry Enhanced for Statement: ");
        ...
        System.out.println("Enhanced Entry for Statement: ");
