...
public class CacheFrequency {
	...
	public static void main(String[] args) {
		CacheFrequency frequencyCache = new CacheFrequency();

		Character[] frequencies1 = frequencyCache.getFrequencies("hello world olympic");
		
		System.out.println(
				"Most frequent character: " + frequencies1[0] + ", Least frequent character: " + frequencies1[1]);

		Character[] frequencies2 = frequencyCache.getFrequencies("Also it is easy to learn it");
