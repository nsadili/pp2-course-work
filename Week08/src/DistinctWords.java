...
public class DistinctWords {
    public static void main(String[] args) {
        List<String> words = initList();

        List<String> distinctWords = new ArrayList<>(new LinkedHashSet<>(words));
        System.out.println("Distinct words in original order: " + distinctWords);

        distinctWords.sort(String.CASE_INSENSITIVE_ORDER);
    ...
    static List<String> initList() {
        ...
        Collections.addAll(collection, "Andrew", "Collins", "Ruth", "Clark", "Melissa", "Bell", "William", "Powell",
                "Ashley", "Perry", "Bonnie", "Jones", "Robert", "Jenkins", "Jonathan", "Long", "Edward", "Kelly", "Fred", "Evans", "Sara",
