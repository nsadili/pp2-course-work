...
public class DistinctWords {
    public static void main(String[] args) 
    {
        ...
        Set<String> uniqueWords = new LinkedHashSet<>(collection);

        // To retain the original order
        ArrayList<String> uniqueWordsInOrder = new ArrayList<>(uniqueWords);

        // To sort the words in alphabetical order
        Collections.sort(uniqueWordsInOrder);

        System.out.println(uniqueWordsInOrder);
