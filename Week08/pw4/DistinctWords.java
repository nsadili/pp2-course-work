...
public class DistinctWords {
    public static void main(String[] args) {
        ...
        Collection<String> uniqueWords = new LinkedHashSet<>(collection);
        System.out.println("Distinct words in order: \n" + uniqueWords);

        Collection<String> orderedWords = new TreeSet<>(uniqueWords);
        System.out.println("Distinct words in alphabetical order: \n" + orderedWords);
