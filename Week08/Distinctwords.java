...
public class Distinctwords {
    public static void main(String[] args) {
        Collection<String> words = initCollection();
        System.out.println("Original words: " + words);
        
     
        List<String> distinctWords = new ArrayList<>(new LinkedHashSet<>(words));
        System.out.println("Distinct words (retaining order): " + distinctWords);
        
       
        Collections.sort(distinctWords);
        System.out.println("Distinct words (sorted alphabetically): " + distinctWords);
    }

    static Collection<String> initCollection() {
        var collection = new ArrayList<String>();
        Collections.addAll(collection,
                "Andrew", "Collins", "Ruth", "Clark", "Melissa", "Bell", "William", "Powell", "Ashley", "Perry","Bonnie", "Jones", "Robert", "Jenkins", "Jonathan", "Long", "Edward", "Kelly", "Fred", "Evans", "Sara",
