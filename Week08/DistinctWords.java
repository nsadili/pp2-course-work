...
public class DistinctWords {
    public static void main(String[] args) {
        ...
        // eliminate duplicates while retaining order
        Collection<String> distinctWords = new LinkedHashSet<>(collection);
        System.out.println("Distinct words with order retained: " + distinctWords);

        // sort the distinct words in alphabetical order
        ArrayList<String> sortedWords = new ArrayList<>(distinctWords);
        Collections.sort(sortedWords);
        System.out.println("Distinct words sorted alphabetically: " + sortedWords);
    }
