...
public class Account implements Comparable<Account> {
    ...
    public static void main(String[] args) {
        ...
        accounts.add(new Account("Vaqif", "Cavadov", 1000));
        accounts.add(new Account("Arda", "Turan", 550));
        accounts.add(new Account("Şamxal", "Şirinov", 1000));
        accounts.add(new Account("Mohammed", "Elneny", 2500));
