...
class PhdStudent extends Student {
    ...
    public boolean equals(PhdStudent pStud) {
        return department.equals(pStud.getDepartment()) &&
                courses.equals(pStud.getCourses()) &&
                super.getFirstName().equals(pStud.getFirstName()) &&
                super.getLastName().equals(pStud.getLastName()) &&
                super.getGender().equals(pStud.getGender());
    }
}
